...
public class Atracao implements PontoDeInteresse{
	...
	public Atracao prototipar() {
		Atracao prototipo = new Atracao();
		prototipo.setNome(this.getNome());
		prototipo.setLatitude(this.getLatitude());
		prototipo.setLongitude(this.getLongitude());
		prototipo.avaliar(this.getEstrelas());
		return prototipo;
	}
