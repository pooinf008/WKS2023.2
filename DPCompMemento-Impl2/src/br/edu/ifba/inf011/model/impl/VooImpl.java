...
import br.edu.ifba.inf011.model.memento.impl2.VooSnapshot;
import br.edu.ifba.inf011.model.memento.impl2.VooSnapshotImpl;
...
public class VooImpl implements VooOriginator{
	...
	public VooSnapshot save() {
		return new VooSnapshotImpl(this.cadeiras);
	}
	
	public void restore(VooSnapshot snapshot) {
		boolean[][] cadeiras =  ((VooSnapshotImpl)snapshot).getState();
