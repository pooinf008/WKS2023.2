...
public class RegraAlocacaoLinha extends AbstractRegraAlocacao {
	
	public RegraAlocacaoLinha(){
		super(null, null);
	}	
	
	public RegraAlocacaoLinha(Integer divisor, AbstractRegraAlocacao sucessor){
