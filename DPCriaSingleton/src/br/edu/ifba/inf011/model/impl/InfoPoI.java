...
public class InfoPoI implements Prototipavel{
	...
	public InfoPoI(String nome, Integer estrelas, Localizacao localizacao) {
		super();
		this.nome = nome;
	...
	public InfoPoI(InfoPoI infoPoI) {
		this(infoPoI.nome, infoPoI.estrelas, (Localizacao)infoPoI.localizacao.prototipar());
	}
