...
public class PassageiroNacional implements Passageiro{
	
	private PassageiroData data = new PassageiroData();

	public PassageiroNacional() {
		
	}
	
	public PassageiroNacional(String nome, String rg, String passaporte) {
		super();
